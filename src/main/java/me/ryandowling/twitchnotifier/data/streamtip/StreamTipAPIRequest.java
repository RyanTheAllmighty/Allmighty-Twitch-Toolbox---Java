...
public class StreamTipAPIRequest {
    private static final String API_BASE = "https://streamtip.com/api";
    private String path = "/";
    ...
    private void connect(String requestMethod, Object object) throws IOException {
        Logger.log("Connecting to " + API_BASE + this.path);
        URL url = new URL(API_BASE + this.path);
